                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            @endif
                                <form method="post" action="{{url('designation/'.$data->id)}}">
                                    @csrf
                                    @method('put')
                                    <div class="form-floating mb-3">
                                        <select class="form-control" id="department" name="department">
                                            ...
                                            <option value="Accounts" {{$data->department == 'Accounts'  ? 'selected' : ''}}>Accounts</option>
                                        </select>
                                        <label for="department">Department</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="designation" name="designation" type="text" value="{{$data->designation}}" />
